...
uses
 ...
 {$IFDEF MSWINDOWS}
{
下面AnsiStrings是Delphi2009+版本才有用，所以增加Delphi版本判断
参考：https://forum.lazarus.freepascal.org/index.php/topic,56598.0.html
...
type
  ...
  TBiosInformation = class
    public
      ...
      { $REGION 'Documentation' }
      /// <summary>
      /// Get the string representation of the燰endor field
      /// </summary>
      { $ENDREGION }
      function VendorStr: AnsiString;
      { $REGION 'Documentation' }
      /// <summary>
      /// Get the string representation of the燰ersion field
      /// </summary>
      { $ENDREGION }
      function VersionStr: AnsiString;
      { $REGION 'Documentation' }
      /// <summary>
      /// Get the string representation of the燫eleaseDate field
      /// </summary>
      { $ENDREGION }
  ...
  TSystemInformation = class
    public
      ...
      { $REGION 'Documentation' }
      /// <summary>
      /// Get the string representation of the燩roductName field
      /// </summary>
      { $ENDREGION }
      ...
      { $REGION 'Documentation' }
      /// <summary>
      /// Get the string representation of the燬erialNumber field
      /// </summary>
      { $ENDREGION }
      function SerialNumberStr: AnsiString;
      { $REGION 'Documentation' }
      /// <summary>
      /// Get the string representation of the燬KUNumber field
      /// </summary>
      { $ENDREGION }
      function SKUNumberStr: AnsiString;
      { $REGION 'Documentation' }
      /// <summary>
      /// Get the string representation of the燜amily field
      /// </summary>
      { $ENDREGION }
  ...
  TBaseBoardInformation = class
    public
      ...
      { $REGION 'Documentation' }
      /// <summary>
      /// Get the description of the燘oardType field
      /// </summary>
      { $ENDREGION }
      ...
      { $REGION 'Documentation' }
      /// <summary>
      /// Get the string representation of the燩roduct field
      /// </summary>
      { $ENDREGION }
      ...
      { $REGION 'Documentation' }
      /// <summary>
      /// Get the string representation of the燗ssetTag field
      /// </summary>
      { $ENDREGION }
      function AssetTagStr: AnsiString;
      { $REGION 'Documentation' }
      /// <summary>
      /// Get the string representation of the燣ocationinChassis field
      /// </summary>
      { $ENDREGION }
  ...
  TEnclosureInformation = class
    public
      ...
      { $REGION 'Documentation' }
      /// <summary>
      /// Get the string representation of the燗ssetTagNumber field
      /// </summary>
      { $ENDREGION }
      function AssetTagNumberStr: AnsiString;
      { $REGION 'Documentation' }
      /// <summary>
      /// Get the description of the燭ype field
      /// </summary>
      { $ENDREGION }
      function TypeStr: AnsiString;
      { $REGION 'Documentation' }
      /// <summary>
      /// Get the description of the燘ootUpState field
      /// </summary>
      { $ENDREGION }
      function BootUpStateStr: AnsiString;
      { $REGION 'Documentation' }
      /// <summary>
      /// Get the description of the燩owerSupplyState field
      /// </summary>
      { $ENDREGION }
  ...
  /// system抯 memory controller(s) and the supported attributes of any
  ...
  /// memory-module socket in the system.燭he structure describes the speed,
  /// type, size, and error status of each system memory module. The
  /// supported attributes of each module are described by the 搊wning
  ...
  TMemoryModuleInfo = packed record
    ...
    { $REGION 'Documentation' }
    /// <summary>
    /// String number for reference designation EXAMPLE: 慗2020
    /// </summary>
    /// <remarks>
    /// 2.0+
    /// </remarks>
    ...
    /// the module抯 presence-detect information. If the system does not
    ...
    /// enabled for the system抯 use from the module. If a module is known to
...
type
  ...
  TProcessorInfo = packed record
    ...
    /// <summary>
    /// <para>
    /// Number of enabled cores per processor socket.營f the value is
  ...
  /// <summary>
  /// the information in this structure defines the attributes of a system
  /// slot. One爏tructure is provided for each slot in the system.
  /// </summary>
  { $ENDREGION }
  ...
  /// of this are爌art numbers for system reference documents, contact
  ...
  TOEMStringsInformation = class
    public
      ...
      { $REGION 'Documentation' }
      /// <summary>
      /// Returns the OEM String based in爐he Index
      /// </summary>
      { $ENDREGION }
  ...
  /// baseboards Jumpers燼nd Switches.
  /// </summary>
  { $ENDREGION }
  ...
  TSystemConfInformation = class
    public
      ...
      { $REGION 'Documentation' }
      /// <summary>
      /// Returns the configuration String based in爐he Index
      /// </summary>
      { $ENDREGION }
  ...
  TBIOSLanguageInformation = class
    public
      ...
      { $REGION 'Documentation' }
      /// <summary>
      /// Returns the Installed language string based in爐he Index
      /// </summary>
      { $ENDREGION }
  ...
  /// together to form a memory address爏pace.
  /// </summary>
  { $ENDREGION }
  ...
  TPhysicalMemoryArrayInformation = class
    public
      ...
      { $REGION 'Documentation' }
      /// <summary>
      /// Get the description of the燯se 爁ield.
      /// </summary>
      { $ENDREGION }
  ...
  /// structure describes a single voltage爌robe.
  /// </summary>
  /// <remarks>
  ...
  /// system. Each structure describes a爏ingle cooling device.
  /// </summary>
  { $ENDREGION }
  ...
  /// in the system. Each structure燿escribes a single electrical current
  /// probe.
  /// </summary>
  { $ENDREGION }
...
{$ENDIF MSWINDOWS}
      ...
      { $REGION 'Documentation' }
      /// <summary>
      /// Save(Dump)爐he TRawSMBIOSData structure to a file
      /// </summary>
      { $ENDREGION }
      procedure SaveToFile(const FileName: string);
      { $REGION 'Documentation' }
      /// <summary>
      /// Load爐he TRawSMBIOSData structure from a file
      /// </summary>
      { $ENDREGION }
      ...
      { $REGION 'Documentation' }
      /// <summary>
      /// Find and load爐he SMBIOS Data from a file
      /// </summary>
      { $ENDREGION }
